...
class SubSettingRecyclerAdapter(
    ...
    override fun onBindViewHolder(holder: MainViewHolder, position: Int) {
        ...
        holder.itemSubSettingBinding.tvUrl.text = if (invitation) {
            holder.itemView.context.getString(R.string.invitation_managed_subscription)
        } else subItem.url
        holder.itemSubSettingBinding.layoutShare.setOnClickListener(null)
        ...
        if (TextUtils.isEmpty(subItem.url)) {
            ...
            holder.itemSubSettingBinding.layoutShare.visibility = if (invitation) View.INVISIBLE else View.VISIBLE
