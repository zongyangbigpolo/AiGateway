...
class SubEditActivity : BaseActivity() {
    ...
    private fun bindingServer(subItem: SubscriptionItem): Boolean {
        val invitation = subItem.invitationOrigin != null
        binding.etRemarks.text = Utils.getEditable(subItem.remarks)
        binding.etUrl.text = if (invitation) null else Utils.getEditable(subItem.url)
        binding.urlSection.visibility = if (invitation) View.GONE else View.VISIBLE
        binding.userAgentSection.visibility = if (invitation) View.GONE else View.VISIBLE
        binding.insecureUrlSection.visibility = if (invitation) View.GONE else View.VISIBLE
    ...
    private fun saveServer(): Boolean {
        ...
        if (subItem.invitationOrigin == null) {
        ...
        if (subItem.invitationOrigin == null && subItem.url.isNotEmpty()) {
